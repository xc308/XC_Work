...
# df
#-----
df_Lon_Strp_4_Srt <- readRDS("df_Lon_Strip_4_Sort_new.rds")


#----------
# 2D coords
#----------
crds <- cbind(df_Lon_Strp_4_Srt$Lon, df_Lon_Strp_4_Srt$Lat)
#head(crds)
...
#str(DSP[, , 1]) # num [1:6855, 1:6855]
#str(DSP[, , 2]) # num [1:6855, 1:6855]
...
# [1]  0.00  0.75  1.50  2.25  3.00  3.75  4.50
# [8]  5.25  6.00  6.75  7.50  8.25  9.00  9.75
# [15] 10.50 11.25 12.00 12.75 13.50 14.25
