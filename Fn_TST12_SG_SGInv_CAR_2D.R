...
# Aim:  
  # Function of TST12
  # for true processes generation, for neg_logL source



# Args:
  # p : # of vairate fields
  # data: data_str reflecting DAG
  # A_mat: a matrix of parameter A
  # dsp_lon_mat: a matrix of Lon displacement
  # dsp_lat_mat: a matrix of Lat displacement
  # dlt_lon_mat: a matrix of parameter dlt in Lon direction
  # dlt_lat_mat: a matrix of parameter dlt in Lat direction
  # b: choice for b function, can be "Tri-Wave" and "Wendland"
  # phi: control spatial dependency in SG_inv for UniCAR
  # H_adj: Adjacency matrix for 2D, obtained from dist() and Nb_radius
  # sig2_mat: a matrix of parameter sig2 for UniCAR
  # reg_ini: initial value for regularize in SpN + Reg for B (matrix of b)
  # thres_ini: initial threshold value to set the element in SG_inv to exact 0.


# Values:
  # SG: a matrix of covariance matrix for desired joint multivariate fields
  # SG_inv: a matrix of precison matrix for desired joint multivariate fields
