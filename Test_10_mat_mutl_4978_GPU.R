...
#----------------------------------------------
# 10 times of 4978 by 4978 multiply 4978 by 4978
#----------------------------------------------
C <- matrix(rnorm(4978*4978), 4978, 4978)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm(4978*4978), 4978, 4978)
...
#------------------------------
# 10 times of 4978*2 by 4978*2
#------------------------------
C <- matrix(rnorm((4978*2)^2), 4978*2, 4978*2)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4978*2)^2), 4978*2, 4978*2)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu
...
#------------------------------
# 10 times of 4978*3 by 4978*3
#------------------------------
C <- matrix(rnorm((4978*3)^2), 4978*3, 4978*3)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4978*3)^2), 4978*3, 4978*3)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu
...
#------------------------------
# 10 times of 4978*4 by 4978*4
#------------------------------
C <- matrix(rnorm((4978*4)^2), 4978*4, 4978*4)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4978*4)^2), 4978*4, 4978*4)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu


C <- matrix(rnorm((4978*4)^2), 4978*4, 4978*4) # 1.8G
C_gpu <- as.gpu.matrix(C, device = "cuda")
