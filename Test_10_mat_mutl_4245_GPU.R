...
#----------------------------------------------
# 10 times of 4245 by 4245 multiply 4245 by 4245
#----------------------------------------------
C <- matrix(rnorm(4245*4245), 4245, 4245)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm(4245*4245), 4245, 4245)
...
#------------------------------
# 10 times of 4245*2 by 4245*2
#------------------------------
C <- matrix(rnorm((4245*2)^2), 4245*2, 4245*2)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4245*2)^2), 4245*2, 4245*2)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu
...
#------------------------------
# 10 times of 4245*3 by 4245*3
#------------------------------
C <- matrix(rnorm((4245*3)^2), 4245*3, 4245*3)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4245*3)^2), 4245*3, 4245*3)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu
...
#------------------------------
# 10 times of 4245*4 by 4245*4
#------------------------------
C <- matrix(rnorm((4245*4)^2), 4245*4, 4245*4)
C_gpu <- as.gpu.matrix(C, device = "cuda")

D <- matrix(rnorm((4245*4)^2), 4245*4, 4245*4)
D_gpu <- as.gpu.matrix(D, device = "cuda")
CD <- C_gpu %*% D_gpu


C <- matrix(rnorm((4245*4)^2), 4245*4, 4245*4) # 1.8G
C_gpu <- as.gpu.matrix(C, device = "cuda")
