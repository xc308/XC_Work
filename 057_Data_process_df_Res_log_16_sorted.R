...
#==========================
# check the data variation
#==========================
# DU
quantile(df_Res_log_16_sorted_DAG_V1$Z1)
#        0%        25%        50%        75%       100% 
# -5.2104560 -1.0315166 -0.1323253  0.7506050  7.2318535 

# SU
quantile(df_Res_log_16_sorted_DAG_V1$Z2)
#        0%        25%        50%        75%       100% 
# -2.9218359 -0.5770226 -0.1299354  0.4903811  4.8861313 

# BC
quantile(df_Res_log_16_sorted_DAG_V1$Z3)
#        0%        25%        50%        75%       100% 
# -3.5100391 -0.7728283 -0.1449330  0.5382639  4.0269475 

# OM
quantile(df_Res_log_16_sorted_DAG_V1$Z4)
#         0%         25%         50%         75%        100% 
# -2.77954781 -0.66927230 -0.03053981  0.55425166  3.83299363 


# SS
quantile(df_Res_log_16_sorted_DAG_V1$Z5)
#         0%         25%         50%         75%        100% 
#-3.23377254 -0.66724588 -0.08795178  0.58158035  3.05080151
