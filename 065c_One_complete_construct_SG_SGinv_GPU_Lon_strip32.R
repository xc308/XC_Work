...
# data:
  # CAMS Lon_strip_32_new.rds (n = 4245, 3.36 GB)
...
# df
#-----
df_Lon_Strp_32_Srt <- readRDS("df_Lon_Strip_32_Sort_new.rds")


#----------
# 2D coords
#----------
crds <- cbind(df_Lon_Strp_32_Srt$Lon, df_Lon_Strp_32_Srt$Lat)
#head(crds)
...
#str(DSP[, , 1]) # num [1:4245, 1:4245]
#str(DSP[, , 2]) # num [1:4245, 1:4245]
...
#[9]  6.00  6.75  7.50  8.25
#[13] 27.75 28.50 29.25 30.00
#[17] 30.75 31.50 32.25 33.00
