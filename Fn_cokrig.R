...
# Aim:
  # cokrig function for C.V. 


# Arg:
  # optm_pars_vec: a vector of optimized parameters
  # all_pars_lst: list of all pars reflecting the graph structure
  # p: # of variate fields
  # data_str: hierachy data reflecting DAG among variate fields
  # h: matrix of displacement
  # H_adj: Adjancency matrix reflecting spatial neighbourhood strucuture for a univariate field
  # phi: the spatial decay parameter, set to be the 1/max(eigen(H_adj)$val)
  # b: the b function, can be "Wendland" (all positive) and "Tri-Wave" (both neg/postive)
  # obs_indx: indexing observations in the df 
  # df: containing spatial locations, and corresponding observations for different variates
...
# Test cokring
#==============
# try using optimzed pars in 047c_WL
